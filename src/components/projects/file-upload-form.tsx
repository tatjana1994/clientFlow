  ...
  return (
    ...
    >
      ...
      <input
        ...
        className='min-w-0 rounded-2xl border border-slate-200 px-4 py-2.5 text-sm file:mr-4 file:rounded-xl file:border-0 file:bg-slate-100 file:px-3 file:py-1.5 file:text-sm file:font-medium'
      />
